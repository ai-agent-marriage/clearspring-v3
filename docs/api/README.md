...
| 字段 | 类型 | 必选 | 说明 |
|------|------|------|------|
| keyword | string | 否 | 搜索关键词（订单号/用户昵称） |
| status | int | 否 | 订单状态筛选 |
| startDate | string | 否 | 开始日期 yyyy-MM-dd |
| endDate | string | 否 | 结束日期 yyyy-MM-dd |
| page | int | 否 | 页码，默认 1 |
    ...
    "list": [
      {
        ...
        "volunteerName": "李师兄",
        "createTime": "2026-04-05 10:00:00",
        "completeTime": "2026-04-05 16:30:00"
      }
    ]
  },
  "timestamp": 1712345678901
...
- **接口名称**: 获取订单详情
- **请求方式**: GET
- **接口地址**: `/api/admin/orders/detail/{id}`
- **是否需要登录**: 是（需管理员权限）
...
```json
{
  ...
  "data": {
    ...
    "executeTime": "2026-04-05 15:00:00",
    "executeLocation": "西湖区 XX 水域",
    "executePhotos": ["https://xxx/photo1.jpg", "https://xxx/photo2.jpg"],
    "executeRemark": "执行顺利，所有物种已安全投放",
    "createTime": "2026-04-05 10:00:00",
    "payTime": "2026-04-05 10:05:00",
...
- **接口名称**: 更新订单状态
- **请求方式**: PUT
- **接口地址**: `/api/admin/orders/status/{id}`
- **是否需要登录**: 是（需管理员权限）
...
- **接口名称**: 删除订单
- **请求方式**: DELETE
- **接口地址**: `/api/admin/orders/delete/{id}`
- **是否需要登录**: 是（需管理员权限）
...
```json
{
  ...
  "msg": "导出成功",
  "data": {
    "fileUrl": "https://xxx/export/orders-20260405.xlsx",
    "fileName": "订单数据_20260405.xlsx",
    "fileSize": "2.5MB",
    "recordCount": 3256,
    "expireTime": "2026-04-12 23:59:59"
  },
...
- **接口名称**: 分配订单
- **请求方式**: PUT
- **接口地址**: `/api/admin/orders/assign/{id}`
- **是否需要登录**: 是（需管理员权限）
...
| 字段 | 类型 | 必选 | 说明 |
|------|------|------|------|
| orgId | long | 是 | 承接机构 ID |
| volunteerId | long | 否 | 执行志愿者 ID |
| remark | string | 否 | 分配备注 |
...
```json
{
  ...
  "data": {
    ...
    "volunteerId": 3001,
    "volunteerName": "李师兄",
    "assignTime": "2026-04-05 14:30:00",
    "assignBy": 1,
    "assignByName": "超级管理员"
  },
  "timestamp": 1712345678901
...
```json
{
  ...
  "data": {
    ...
    "statusDistribution": [
      {"status": 1, "statusName": "待承接", "count": 45, "percentage": 1.4},
      {"status": 2, "statusName": "待执行", "count": 68, "percentage": 2.1},
      {"status": 3, "statusName": "执行中", "count": 43, "percentage": 1.3},
      {"status": 4, "statusName": "待确认", "count": 52, "percentage": 1.6},
      {"status": 5, "statusName": "已完成", "count": 2890, "percentage": 88.8},
      {"status": 6, "statusName": "已取消", "count": 158, "percentage": 4.8}
    ],
    "trend": [
      {"date": "2026-04-01", "count": 85, "amount": 38250},
      {"date": "2026-04-02", "count": 92, "amount": 41400},
      {"date": "2026-04-03", "count": 88, "amount": 39600}
    ]
  },
  "timestamp": 1712345678901
}
...
- **接口名称**: 订单复核
- **请求方式**: PUT
- **接口地址**: `/api/admin/orders/review/{id}`
- **是否需要登录**: 是（需管理员权限）
...
| 字段 | 类型 | 必选 | 说明 |
|------|------|------|------|
| reviewResult | int | 是 | 复核结果 1 通过 0 拒绝 |
| reviewRemark | string | 是 | 复核意见 |
...
```json
{
  ...
  "data": {
    ...
    "reviewResult": 1,
    "reviewResultName": "通过",
    "reviewRemark": "执行结果符合要求，复核通过",
    "reviewTime": "2026-04-05 17:00:00",
    "reviewBy": 1,
    "reviewByName": "超级管理员"
  },
  "timestamp": 1712345678901
...
- **接口名称**: 获取物种列表
- **请求方式**: GET
- **接口地址**: `/api/admin/content/species/list`
- **是否需要登录**: 是（需管理员权限）
...
- **接口名称**: 新增物种
- **请求方式**: POST
- **接口地址**: `/api/admin/content/species/add`
- **是否需要登录**: 是（需管理员权限）
...
- **接口名称**: 更新物种
- **请求方式**: PUT
- **接口地址**: `/api/admin/content/species/update/{id}`
- **是否需要登录**: 是（需管理员权限）
...
- **接口名称**: 删除物种
- **请求方式**: DELETE
- **接口地址**: `/api/admin/content/species/delete/{id}`
- **是否需要登录**: 是（需管理员权限）
...
- **接口名称**: 获取禅理列表
- **请求方式**: GET
- **接口地址**: `/api/admin/content/zen/list`
- **是否需要登录**: 是（需管理员权限）
...
- **接口名称**: 新增禅理
- **请求方式**: POST
- **接口地址**: `/api/admin/content/zen/add`
- **是否需要登录**: 是（需管理员权限）
...
| author | string | 是 | 作者 |
| source | string | 否 | 出处 |
| category | string | 否 | 分类：修身/慈悲/智慧/其他 |
| status | int | 否 | 状态 1 启用 0 禁用，默认 1 |
| backgroundImages | array | 否 | 背景图 URL 列表 |
...
*清如 V3 · API 接口文档 V1.14 更新完成* 🌊

**文档版本**: V1.14  
**创建日期**: 2026-04-04  
**最后更新**: 2026-04-05  
**Day 19 新增接口**: 
- 管理后台订单管理接口（8 个）：获取订单列表、获取订单详情、更新订单状态、删除订单、导出订单数据、分配订单、获取订单统计、订单复核
- 管理后台内容管理接口（6 个）：获取物种列表、新增物种、更新物种、删除物种、获取禅理列表、新增禅理
- Day 19 新增接口总数：14 个

**Day 20 新增接口**:
- 财务管理接口（8 个）：获取财务统计、获取订单财务列表、获取结算列表、确认结算、获取发票列表、更新发票状态、导出财务数据、获取营收数据
- 系统设置接口（6 个）：获取系统设置列表、更新系统设置、获取备份列表、创建备份、获取系统日志、清除缓存
- Day 20 新增接口总数：14 个
...
```json
{
  ...
  "data": {
    "overview": {
      "totalRevenue": 1456000.00,
      "totalSettlement": 1310400.00,
      "totalPlatformFee": 145600.00,
      "pendingSettlement": 45000.00,
      "completedOrders": 2890,
      "pendingOrders": 156
    },
    "today": {
    ...
    "trend": [
      {"date": "2026-04-01", "revenue": 38250, "settlement": 34425},
      {"date": "2026-04-02", "revenue": 41400, "settlement": 37260},
      {"date": "2026-04-03", "revenue": 39600, "settlement": 35640}
    ]
  },
  "timestamp": 1712345678901
}
    ...
    "list": [
      {
        ...
        "createTime": "2026-04-05 10:00:00",
        "settlementTime": "2026-04-12 10:00:00"
      }
    ]
  },
  "timestamp": 1712345678901
...
- **接口名称**: 获取结算列表
- **请求方式**: GET
- **接口地址**: `/api/admin/finance/settlements`
- **是否需要登录**: 是（需管理员权限）
...
```json
{
  ...
  "data": {
    ...
    "list": [
      {
        "settlementId": "SET202604050001",
        "settlementNo": "SETTLE202604050001",
        "orgId": 1001,
        "orgName": "杭州护生协会",
        "orderNo": "ORD202604050001",
        "settlementAmount": 450.00,
        ...
        "statusName": "已确认",
        "createTime": "2026-04-05 14:30:00",
        "confirmTime": "2026-04-06 10:00:00",
        "paymentTime": null
      }
    ]
  },
...
```json
{
  ...
  "data": {
    ...
    "status": 2,
    "statusName": "已确认",
    "confirmTime": "2026-04-05 17:00:00",
    "confirmBy": 1,
    "confirmByName": "超级管理员"
  },
  "timestamp": 1712345678901
...
- **接口名称**: 获取发票列表
- **请求方式**: GET
- **接口地址**: `/api/admin/finance/invoices`
- **是否需要登录**: 是（需管理员权限）
...
|------|------|------|------|
| orgId | long | 否 | 机构 ID 筛选 |
| status | int | 否 | 发票状态 1 待开具 2 已开具 3 已寄送 |
| startDate | string | 否 | 开始日期 yyyy-MM-dd |
| endDate | string | 否 | 结束日期 yyyy-MM-dd |
| page | int | 否 | 页码，默认 1 |
| pageSize | int | 否 | 每页数量，默认 20 |
...
```json
{
  ...
  "data": {
    ...
    "list": [
      {
        "invoiceId": "INV202604050001",
        "invoiceNo": "发票代码 123456",
        "orgId": 1001,
        "orgName": "杭州护生协会",
        "amount": 450.00,
        "type": 1,
        ...
        "status": 2,
        "statusName": "已开具",
        "applyTime": "2026-04-05 10:00:00",
        "issueTime": "2026-04-06 14:30:00"
      }
    ]
  },
  "timestamp": 1712345678901
...
- **接口名称**: 更新发票状态
- **请求方式**: PUT
- **接口地址**: `/api/admin/finance/invoice/{id}`
- **是否需要登录**: 是（需管理员权限）
...
| 字段 | 类型 | 必选 | 说明 |
|------|------|------|------|
| status | int | 是 | 发票状态 1 待开具 2 已开具 3 已寄送 |
| remark | string | 否 | 备注 |
...
```json
{
  ...
  "data": {
    ...
    "status": 3,
    "statusName": "已寄送",
    "updateTime": "2026-04-05 17:00:00",
    "updateBy": 1,
    "updateByName": "超级管理员"
  },
  "timestamp": 1712345678901
...
| startDate | string | 是 | 开始日期 yyyy-MM-dd |
| endDate | string | 是 | 结束日期 yyyy-MM-dd |
| exportType | string | 是 | 导出类型：orders/settlements/invoices |
| format | string | 否 | 导出格式：xlsx/csv，默认 xlsx |
...
```json
{
  ...
  "msg": "导出成功",
  "data": {
    "fileUrl": "https://xxx/export/finance-20260405.xlsx",
    "fileName": "财务数据_20260405.xlsx",
    "fileSize": "1.5MB",
    "recordCount": 1256,
    "expireTime": "2026-04-12 23:59:59"
  },
...
- **接口名称**: 获取营收数据
- **请求方式**: GET
- **接口地址**: `/api/admin/finance/revenue`
- **是否需要登录**: 是（需管理员权限）
...
```json
{
  ...
  "data": {
    "overview": {
      "totalRevenue": 1456000.00,
      "totalPlatformFee": 145600.00,
      "avgOrderValue": 447.26
    },
    "trend": [
      {"date": "2026-04-01", "revenue": 38250, "orderCount": 85, "platformFee": 3825},
      {"date": "2026-04-02", "revenue": 41400, "orderCount": 92, "platformFee": 4140},
      {"date": "2026-04-03", "revenue": 39600, "orderCount": 88, "platformFee": 3960}
    ]
  },
  "timestamp": 1712345678901
}
...
## ⚙️ 二十九、管理后台系统设置接口（Phase 2 Day 20）
...
| 字段 | 类型 | 必选 | 说明 |
|------|------|------|------|
| category | string | 否 | 设置分类：basic/payment/notification/other |
| keyword | string | 否 | 搜索关键词 |
...
- **接口名称**: 更新系统设置
- **请求方式**: PUT
- **接口地址**: `/api/admin/settings/update/{key}`
- **是否需要登录**: 是（需管理员权限）
...
- **接口名称**: 获取备份列表
- **请求方式**: GET
- **接口地址**: `/api/admin/settings/backup`
- **是否需要登录**: 是（需管理员权限）
...
| 字段 | 类型 | 必选 | 说明 |
|------|------|------|------|
| type | string | 否 | 备份类型：database/config/all |
| page | int | 否 | 页码，默认 1 |
| pageSize | int | 否 | 每页数量，默认 20 |
...
```json
{
  ...
  "data": {
    ...
    "list": [
      {
        "backupId": "BACKUP202604050001",
        "type": "database",
        "typeName": "数据库备份",
        "fileName": "backup-20260405.sql",
        "fileSize": "125.6MB",
        "status": 1,
        "statusName": "成功",
        "createTime": "2026-04-05 02:00:00",
        "downloadUrl": "https://xxx/backup/backup-20260405.sql"
      }
    ]
  },
  "timestamp": 1712345678901
...
| 字段 | 类型 | 必选 | 说明 |
|------|------|------|------|
| type | string | 是 | 备份类型：database/config/all |
| remark | string | 否 | 备注 |
...
```json
{
  ...
  "msg": "备份任务已创建",
  "data": {
    "backupId": "BACKUP202604050002",
    "type": "database",
    "status": 0,
    "statusName": "进行中",
    "createTime": "2026-04-05 17:00:00",
    "estimatedTime": "2026-04-05 17:10:00"
  },
  "timestamp": 1712345678901
}
```
...
| module | string | 否 | 模块：order/payment/user/system |
| startDate | string | 否 | 开始日期 yyyy-MM-dd HH:mm:ss |
...
```json
{
  ...
  "data": {
    ...
    "list": [
      {
        "logId": "LOG202604050001",
        "level": "INFO",
        "module": "order",
        "action": "订单创建",
        "content": "用户 1001 创建订单 ORD202604050001",
        "operatorId": 1001,
        "operatorName": "张师兄",
        "ip": "192.168.1.100",
        "createTime": "2026-04-05 10:00:00"
...
| 字段 | 类型 | 必选 | 说明 |
|------|------|------|------|
| cacheType | string | 是 | 缓存类型：all/user/content/system |
| reason | string | 否 | 清除原因 |
...
*清如 V3 · API 接口文档 V1.15 更新完成* 🌊

**文档版本**: V1.15  
**创建日期**: 2026-04-04  
**最后更新**: 2026-04-04  
**Week 4 新增接口汇总（Day 18-20）**: 
...
|------|---------|------|
| 控制台首页 | 3 个 | 管理后台仪表盘数据 |
| 用户管理 | 5 个 | 用户列表/详情/状态管理 |
| 订单管理 | 8 个 | 订单列表/详情/操作/统计 |
| 内容管理 | 6 个 | 物种/禅理管理 |
| 财务管理 | 8 个 | 财务统计/结算/发票管理 |
| 系统设置 | 6 个 | 系统配置/备份/日志/缓存 |
| **合计** | **36 个** | Phase 2 Week 4 新增 |
